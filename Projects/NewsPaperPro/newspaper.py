...
T.place(x=50, y=100)
# image
photo = PhotoImage(file="images/book-worm.png")
P = Label(image=photo)
P.place(x=600, y=70)
...
photo1 = PhotoImage(file="images/book-worm.png")
...
photo2 = PhotoImage(file="images/book-worm.png")
...
photo3 = PhotoImage(file="images/book-worm.png")
